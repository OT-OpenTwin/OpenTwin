...
namespace ot {
	...
	public:
		...
		static constexpr inline QColor toQColor(const ot::Color& _color) noexcept { return QColor(_color.r(), _color.g(), _color.b(), _color.a()); };
		static constexpr inline QColor toQColor(const ot::ColorF& _color) noexcept { return QColor((int)(_color.r() * 255.f), (int)(_color.g() * 255.f), (int)(_color.b() * 255.f), (int)(_color.a() * 255.f)); };
		...
		static constexpr inline QPoint toQPoint(const Point2D& _pt) noexcept { return QPoint(_pt.x(), _pt.y()); };
		static constexpr inline QPointF toQPoint(const Point2DF& _pt) noexcept { return QPointF((qreal)_pt.x(), (qreal)_pt.y()); };
		static constexpr inline QPointF toQPoint(const Point2DD& _pt) noexcept { return QPointF((qreal)_pt.x(), (qreal)_pt.y()); };
		...
		static constexpr inline QSize toQSize(const Size2D& _s) noexcept { return QSize(_s.width(), _s.height()); };
		static constexpr inline QSizeF toQSize(const Size2DF& _s) noexcept { return QSizeF((qreal)_s.width(), (qreal)_s.height()); };
		static constexpr inline QSizeF toQSize(const Size2DD& _s) noexcept { return QSizeF((qreal)_s.width(), (qreal)_s.height()); };
		...
		static inline QPen toQPen(const Outline& _outline) { return QPen(toQBrush(_outline.painter()), (qreal)_outline.width(), toQPenStyle(_outline.style()), toQPenCapStyle(_outline.cap()), toQPenJoinStyle(_outline.joinStyle())); };
		static inline QPen toQPen(const OutlineF& _outline) { return QPen(toQBrush(_outline.painter()), _outline.width(), toQPenStyle(_outline.style()), toQPenCapStyle(_outline.cap()), toQPenJoinStyle(_outline.joinStyle())); };
