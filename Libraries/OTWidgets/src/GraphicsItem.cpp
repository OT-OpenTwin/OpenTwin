...
bool ot::GraphicsItem::hasMoved() const {
	return this->getQGraphicsItem()->pos() != m_moveStartPt;
}

bool ot::GraphicsItem::notifyMoveIfRequired(GraphicsChangeEvent& _changeEvent) {
