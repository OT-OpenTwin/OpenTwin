...
// OpenTwin header
#include "OpenTwinCore/Flags.h"	// Flags
#include "OpenTwinCore/rJSON.h" // rJSON doc/val
#include "OpenTwinCommunication/CommunicationTypes.h" // MessageType type
#include "OpenTwinFoundation/FoundationAPIExport.h" // API export
