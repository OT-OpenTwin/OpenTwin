...
class OT_CADENTITIES_API_EXPORT EntityFieldDump : public EntityFaceAnnotation
{
public:
	EntityFieldDump();
	EntityFieldDump(ot::UID ID, EntityBase *parent, EntityObserver *obs, ModelState *ms);
	virtual ~EntityFieldDump();

	virtual bool updateFromProperties(void) override;

	virtual void storeToDataBase(void) override;

	static std::string className() { return "EntityFieldDump"; };
	virtual std::string getClassName(void) const override { return EntityFieldDump::className(); };
