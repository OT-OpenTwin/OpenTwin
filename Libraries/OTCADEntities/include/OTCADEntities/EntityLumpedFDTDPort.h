...
class OT_CADENTITIES_API_EXPORT EntityLumpedFDTDPort : public EntityGeometry
{
public:
	EntityLumpedFDTDPort() : EntityLumpedFDTDPort(0, nullptr, nullptr, nullptr) {};
	EntityLumpedFDTDPort(ot::UID ID, EntityBase* parent, EntityObserver* obs, ModelState* ms);
	virtual ~EntityLumpedFDTDPort();
