...
//! @param ___expression Expression to check. If false, the assertion will be triggered.
//! @param ... Custom text to display in the assertion message.
#define OTAssert(___expression, ...) (void)((!!(___expression)) || (_wassert(_CRT_WIDE(#___expression) L"\n\n" _CRT_WIDE("" __VA_ARGS__), _CRT_WIDE(__FILE__), (unsigned)__LINE__), 0))
