...
#include "OTDataStorage/Response/DataStorageResponse.h"
...
namespace DataStorageAPI
{
	...
	public:
		...
		DataStorageResponse insertDocumentToDataLakePartition(BsonViewOrValue& _jsonData, bool _checkForExistence, bool _allowQueueing);
