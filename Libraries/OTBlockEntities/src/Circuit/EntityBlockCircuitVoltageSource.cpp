// @otlicense
// File: EntityBlockCircuitVoltageSource.cpp
// 
// License:
...
bool EntityBlockCircuitVoltageSource::getFlipHorizontal() const {
...
bool EntityBlockCircuitVoltageSource::getFlipVertical() const {
...
void EntityBlockCircuitVoltageSource::readSpecificDataFromDataBase(const bsoncxx::document::view& doc_view, std::map<ot::UID, EntityBase*>& entityMap)
{
