...
void EntityVisCartesianVectorVolume::createProperties(void)
{
	...
	propertyBundleVisCartesianVector.setProperties(this);
...
bool EntityVisCartesianVectorVolume::updatePropertyVisibilities(void)
{
	...
	updatePropertiesGrid |= propertyBundleVisCartesianVector.updatePropertyVisibility(this);

	if (propertyBundleVisCartesianVector.is2dType(this))
	{
