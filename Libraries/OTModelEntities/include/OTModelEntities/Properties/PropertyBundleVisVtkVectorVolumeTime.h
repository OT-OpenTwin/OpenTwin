// @otlicense
// File: PropertyBundleVisVtkVectorVolumeTime.h
// 
// License:
...
class __declspec(dllexport) PropertyBundleVisVtkVectorVolumeTime : public PropertyBundle
{
public:
	...
	void setTimeList(EntityBase* _thisObject, const std::list<double>& timeList);
...
private:
	...
	const std::string m_groupNameTime = "Time";
};
