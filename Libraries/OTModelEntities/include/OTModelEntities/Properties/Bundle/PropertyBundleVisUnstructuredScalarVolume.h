// @otlicense
// File: PropertyBundleVisUnstructuredScalarVolume.h
// 
// License:
...
#include "OTModelEntities/Properties/PropertiesVisUnstructuredScalar.h"

class __declspec(dllexport) PropertyBundleVisUnstructuredScalarVolume : public PropertyBundle
{
public:
