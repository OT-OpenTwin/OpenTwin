// @otlicense
// File: PropertyBundleDataHandleVisVectorVolumeTime.h
// 
// License:
...
#include "OTModelEntities/Properties/PropertiesVisCartesianVector.h"

class _declspec(dllexport) PropertyBundleDataHandleVisVectorVolumeTime : public PropertyBundleDataHandle
{
public:
	PropertyBundleDataHandleVisVectorVolumeTime(EntityBase * thisObject);
	...
	const double GetTime(void) { return time; }
