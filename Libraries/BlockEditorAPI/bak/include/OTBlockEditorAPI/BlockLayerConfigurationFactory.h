//! @file BlockLayerConfigurationFactory.h
...
namespace ot {
	...
	namespace BlockLayerConfigurationFactory {

		//! @brief Creates an empty block layer configuration for the given type
		//! @param _type A valid block layer configuration type
		BLOCKEDITORAPI_API_EXPORT BlockLayerConfiguration* blockLayerConfigurationFromType(const std::string& _type);
		...
		BLOCKEDITORAPI_API_EXPORT BlockLayerConfiguration* blockLayerConfigurationFromJson(OT_rJSON_val& _object);
	}
}
