...
namespace ViewerAPI {
	...
	__declspec(dllexport) void selectObject(ot::UID _osgModelID, const std::string &name);
	...
	__declspec(dllexport) ot::EntityTreeItem getEntityTreeItem(ot::UID _modelEntityID);
