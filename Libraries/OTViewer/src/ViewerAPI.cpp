...
#include "OTViewer/GlobalModel.h"
...
void ViewerAPI::addVisualizationContainerNode(ot::UID _osgModelID, const ot::EntityTreeItem& _treeItem, const ot::VisualisationTypes& _visualisationTypes, bool _requiresGlobalTransformationMatrix)
{
	try
	{
		Model *model = intern::OsgModelManager::uidToModelMap().at(_osgModelID);

		model->addVisualizationContainerNode(_treeItem, _visualisationTypes, _requiresGlobalTransformationMatrix);
	}
	catch (std::out_of_range)
	{
		throw std::exception("The specified model does not exist");
...
void ViewerAPI::addCoordinateSystemNode(ot::UID _osgModelID, const ot::EntityTreeItem& _treeItem, const ot::VisualisationTypes& _visualisationTypes, std::vector<double>& coordinateSettings, bool isActive)
{
	try
	{
		Model* model = intern::OsgModelManager::uidToModelMap().at(_osgModelID);

		model->addCoordinateSystemNode(_treeItem, _visualisationTypes, coordinateSettings, isActive);
	}
	catch (std::out_of_range)
	{
		throw std::exception("The specified model does not exist");
...
void ViewerAPI::updateCoordinateSystemNode(ot::UID _osgModelID, const ot::EntityTreeItem& _treeItem, std::vector<double>& coordinateSettings, bool isActive)
{
	try
	{
		Model* model = intern::OsgModelManager::uidToModelMap().at(_osgModelID);

		model->updateCoordinateSystemNode(_treeItem, coordinateSettings, isActive);
	}
	catch (std::out_of_range)
	{
		throw std::exception("The specified model does not exist");
...
void ViewerAPI::addVTKNode(ot::UID _osgModelID, const ot::EntityTreeItem& _treeItem, bool _isHidden, const std::string& _projectName, ot::UID _dataEntityID, ot::UID _dataEntityVersion, const std::string& colorRampData, const std::string& unit)
{
	try
	{
		Model *model = intern::OsgModelManager::uidToModelMap().at(_osgModelID);

		model->addVTKNode(_treeItem, _isHidden, _projectName, _dataEntityID, _dataEntityVersion, colorRampData, unit);
	}
	catch (std::out_of_range)
	{
		throw std::exception("The specified model does not exist");
...
void ViewerAPI::updateVTKNode(ot::UID _osgModelID, ot::UID _entityID, const std::string& _projectName, ot::UID _dataEntityID, ot::UID _dataEntityVersion, const std::string& colorRampData, const std::string& unit)
{
	try
	{
		Model *model = intern::OsgModelManager::uidToModelMap().at(_osgModelID);

		model->updateVTKNode(_entityID, _projectName, _dataEntityID, _dataEntityVersion, colorRampData, unit);
	}
	catch (std::out_of_range)
	{
		throw std::exception("The specified model does not exist");
