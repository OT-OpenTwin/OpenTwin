	...
	: WidgetView(WidgetViewBase::View3D, _parent)
{
	...
	OT_VIEWER_DBG_PTR(this, "ViewerView created with { \"Viewer.ptr\": \"0x" + String::ptrToHexString(m_viewer) + "\", \"ID\": " + std::to_string(_viewerID));
}

ot::ViewerView::~ViewerView() {
	delete m_viewer;
	m_viewer = nullptr;
	OT_VIEWER_DBG_PTR(this, "ViewerView destroyed");
}
