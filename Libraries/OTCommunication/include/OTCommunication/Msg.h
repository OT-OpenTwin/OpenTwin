...
namespace ot {
	namespace msg {
		...
		OT_COMMUNICATION_API_EXPORT bool send(const std::string& _senderIP, const std::string& _receiverIP, ot::MessageType _type, const std::string& _message, std::string& _response, int _timeout = 0, bool _shutdownMessage = false, bool _createLogMessage = true);
		...
		//! @param _message The message to send
		//! @param _response Here the response will be written to
		OT_COMMUNICATION_API_EXPORT void sendAsync(const std::string& _senderIP, const std::string& _receiverIP, ot::MessageType _type, const std::string& _message, int _timeout = 0, bool _createLogMessage = true);
	}
}