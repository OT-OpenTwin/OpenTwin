...
void ot::components::UiComponent::enterEntitySelectionMode(
	...
	case ot::components::UiComponent::BLEND_EDGE: cmdDoc.AddMember(OT_ACTION_PARAM_MODEL_ITM_Selection_Action, JsonString("BLEND_EDGE", cmdDoc.GetAllocator()), cmdDoc.GetAllocator()); break;
	case ot::components::UiComponent::TRANSFORM_LOCALCOORDINATESYSTEM: cmdDoc.AddMember(OT_ACTION_PARAM_MODEL_ITM_Selection_Action, JsonString("TRANSFORM_LOCALCOORDINATESYSTEM", cmdDoc.GetAllocator()), cmdDoc.GetAllocator()); break;
	case ot::components::UiComponent::ALIGN_LCS_FACE: cmdDoc.AddMember(OT_ACTION_PARAM_MODEL_ITM_Selection_Action, JsonString("ALIGN_LCS_FACE", cmdDoc.GetAllocator()), cmdDoc.GetAllocator()); break;
	case ot::components::UiComponent::ALIGN_LCS_EDGE: cmdDoc.AddMember(OT_ACTION_PARAM_MODEL_ITM_Selection_Action, JsonString("ALIGN_LCS_EDGE", cmdDoc.GetAllocator()), cmdDoc.GetAllocator()); break;
