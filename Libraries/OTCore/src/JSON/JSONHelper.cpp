...
#define OT_JSON_checkMemberExists(___object, ___memberName, ___errorAction) if (!___object.HasMember(___memberName)) { OTAssert(0, "JSON object member missing"); OT_LOG_E("JSON object member \"" + std::string(___memberName) + "\" missing"); ___errorAction; }
...
#define OT_JSON_checkMemberIteratorType(___it, ___memberName, ___memberType, ___errorAction) if (!___it->value.Is##___memberType()) { OTAssert(0, "JSON object member invalid type"); OT_LOG_E("JSON object member \"" + std::string(___memberName) + "\" is not a " #___memberType); ___errorAction; }
