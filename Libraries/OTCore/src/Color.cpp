...
int ot::Color::channelValueFromFloat(float _value) {
	return static_cast<int>(_value * 255.f);
}
...
float ot::ColorF::channelValueFromInt(int _value) {
	return static_cast<float>(_value) / 255.f;
}
