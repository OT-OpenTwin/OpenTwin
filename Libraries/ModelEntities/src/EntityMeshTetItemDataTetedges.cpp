// @otlicense
// File: EntityMeshTetItemDataTetedges.cpp
// 
// License:
...
EntityMeshTetItemDataTetedges::EntityMeshTetItemDataTetedges(ot::UID ID, EntityBase *parent, EntityObserver *obs, ModelState *ms) :
...
void EntityMeshTetItemDataTetedges::readSpecificDataFromDataBase(const bsoncxx::document::view &doc_view, std::map<ot::UID, EntityBase *> &entityMap)
{
