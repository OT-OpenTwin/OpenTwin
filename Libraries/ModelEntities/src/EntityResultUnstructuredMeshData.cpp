// @otlicense
// File: EntityResultUnstructuredMeshData.cpp
// 
// License:
...
EntityResultUnstructuredMeshData::EntityResultUnstructuredMeshData(ot::UID ID, EntityBase* parent, EntityObserver* obs, ModelState* ms)
...
void EntityResultUnstructuredMeshData::readSpecificDataFromDataBase(const bsoncxx::document::view & doc_view, std::map<ot::UID, EntityBase*>& entityMap)
{
