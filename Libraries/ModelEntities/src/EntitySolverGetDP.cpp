...
EntitySolverGetDP::EntitySolverGetDP(ot::UID ID, EntityBase *parent, EntityObserver *obs, ModelState *ms, ClassFactory *factory, const std::string &owner) : EntitySolver(ID, parent, obs, ms, factory, owner)
{
}
