// @otlicense
// File: EntityMeshTetFaceData.cpp
// 
// License:
...
void EntityMeshTetFaceData::readSpecificDataFromDataBase(const bsoncxx::document::view &doc_view, std::map<ot::UID, EntityBase *> &entityMap)
{
