...
namespace ot {
	...
	class OT_GUI_API_EXPORT NavigationTreeItemCfg : public ot::Serializable {
	public:
		enum ItemFlag {
		...
		NavigationTreeItemCfg();
		NavigationTreeItemCfg(const std::string& _text, const ItemFlags& _flags = NoItemFlags);
		NavigationTreeItemCfg(const std::string& _text, const std::string& _iconPath, const ItemFlags& _flags = NoItemFlags);
		NavigationTreeItemCfg(const std::string& _text, const std::string& _iconPath, const std::list<NavigationTreeItemCfg>& _childItems, const ItemFlags& _flags = NoItemFlags);
		NavigationTreeItemCfg(const NavigationTreeItemCfg& _other);
		virtual ~NavigationTreeItemCfg();

		NavigationTreeItemCfg& operator = (const NavigationTreeItemCfg& _other);
		...
		void addChildItem(const NavigationTreeItemCfg& _item);
		void setChildItems(const std::list<NavigationTreeItemCfg>& _items);
		const std::list<NavigationTreeItemCfg>& getChildItems() const { return m_childs; };
		...
		void merge(const NavigationTreeItemCfg& _other);
	...
	protected:
		void setParentNavigationTreeItem(NavigationTreeItemCfg* _parent) { m_parent = _parent; };
		NavigationTreeItemCfg* parentNavigationTreeItem() const { return m_parent; };

	private:
		NavigationTreeItemCfg* m_parent;

		std::string m_text;
		NavigationTreeItemIcon m_icon;
		std::list<NavigationTreeItemCfg> m_childs;
		ItemFlags m_flags;
...
OT_ADD_FLAG_FUNCTIONS(ot::NavigationTreeItemCfg::ItemFlag, ot::NavigationTreeItemCfg::ItemFlags)