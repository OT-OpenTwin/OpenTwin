...
namespace ot {
	...
	public:
		...
		virtual std::string getFactoryKey() const override { return std::string(OT_FactoryKey_StyleRefPainter2D); };
		...
		ColorStyleValueEntry getReferenceKey() const { return m_reference; };
