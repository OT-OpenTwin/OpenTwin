...
ot::Plot1DCfg::Plot1DCfg() : 
	WidgetViewBase(WidgetViewBase::View1D, WidgetViewBase::ViewIsCentral | WidgetViewBase::ViewIsCloseable), m_type(Plot1DCfg::Cartesian), m_axisQuantity(Plot1DCfg::Real),
