...
static ot::GraphicsItemCfgFactoryRegistrar<ot::GraphicsTriangleItemCfg> triaItemCfg(ot::GraphicsTriangleItemCfg::className());
...
ot::GraphicsTriangleItemCfg::GraphicsTriangleItemCfg(const GraphicsTriangleItemCfg& _other)
	: ot::GraphicsItemCfg(_other), m_outline(_other.m_outline), m_size(_other.m_size),
	m_direction(_other.m_direction), m_shape(_other.m_shape)
{
