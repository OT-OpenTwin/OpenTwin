	...
	: GraphicsEllipseItemCfg(5., 5., nullptr)
{
	...
	this->setGraphicsItemFlags(GraphicsItemFlag::ItemHandlesState | GraphicsItemFlag::ItemIsConnectable | GraphicsItemFlag::ItemIsMoveable | GraphicsItemFlag::ItemSnapsToGrid);
}