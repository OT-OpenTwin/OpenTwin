...
#ifndef OSGGA_VIEW_MANIPULATOR
#define OSGGA_VIEW_MANIPULATOR 1
...
namespace osgGA {
	...
	/** ViewManipulator is base class for camera control based on focal center,
	...
	class ViewManipulator : public StandardManipulator
	{
	...
	public:
		...
		ViewManipulator(const ViewManipulator& om,
			const osg::CopyOp& copyOp = osg::CopyOp::SHALLOW_COPY);

		//META_Object(osgGA, ViewManipulator);
		...
		void setHandleMouseMovement(bool flag) { handleMouseMovement = flag; }
	...
	inline double ViewManipulator::getTrackballSize() const { return _trackballSize; }
	/** Get the mouse wheel zoom factor.*/
	inline double ViewManipulator::getWheelZoomFactor() const { return _wheelZoomFactor; }
