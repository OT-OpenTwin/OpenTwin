...
#define OT_rJSON_checkMemberExists(___object, ___memberName) if (!___object.HasMember(___memberName)) { OT_LOG_E("JSON object member \"" + std::string(___memberName) + "\" is missing"); throw std::exception("JSON object member \"" ___memberName "\" missing"); }
...
#define OT_rJSON_checkMemberType(___object, ___memberName, ___memberType) if (!___object[___memberName].Is##___memberType()) { OT_LOG_E("JSON object member \"" + std::string(___memberName) + "\" is not a " #___memberType); throw std::exception("JSON object member \"" ___memberName "\" invalid type"); }
