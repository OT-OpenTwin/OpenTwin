...
const std::string MetadataVectorizer::m_separator = "~";

void MetadataVectorizer::vectorize(const ot::JsonValue& _value, std::list<std::string>& _allEntries, const std::string& _nameBase)
{
	if (_value.IsObject())
	{
...
const ot::JsonValue& MetadataVectorizer::getValue(const ot::JsonDocument& _structure, const std::string& _fieldName)
{
