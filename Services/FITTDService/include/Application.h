...
public:
	...
	virtual bool startAsRelayService(void) const override { return false; };
	...
	virtual ot::SettingsData * createSettings(void) override { return nullptr; };
	...
	virtual bool settingChanged(ot::AbstractSettingsItem * _item) { return false; };
