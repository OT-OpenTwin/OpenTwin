...
ElmerFEMLauncher::ElmerFEMLauncher(Application *app)
	: application(app)
{

}

ElmerFEMLauncher::~ElmerFEMLauncher()
{

}

std::string ElmerFEMLauncher::startSolver(std::string &logFileText, const std::string &dataBaseURL, const std::string &uiUrl, const std::string &projectName, EntityBase* solverEntity, int serviceID, int sessionCount, ot::components::ModelComponent *modelComponent)
{
...
void ElmerFEMLauncher::readGroupsFromMesh(const std::string& meshFileName, std::map<std::string, size_t>& groupNameToIdMap)
{
...
std::string ElmerFEMLauncher::getProblemType(EntityBase* solverEntity)
{
...
std::string ElmerFEMLauncher::extractMesh(EntityBase* solverEntity, const std::string &tempDirPath, ot::UID &meshDataID, std::string &currentMeshDataName)
{
...
std::string ElmerFEMLauncher::readOutputFile(const std::string &fileName)
{
...
std::string ElmerFEMLauncher::getUniqueTempDir(void)
{
...
bool ElmerFEMLauncher::deleteDirectory(const std::string &pathName)
{
