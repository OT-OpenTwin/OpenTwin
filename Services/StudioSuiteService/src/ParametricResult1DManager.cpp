...
void ParametricResult1DManager::add(Result1DManager& result1DManager)
{
	...
	processCurves("1D Results/Balance", runIDLabel, runIDList, result1DManager);
	//processCurves("1D Results/Energy", runIDLabel, runIDList, result1DManager);
	processCurves("1D Results/Port signals", runIDLabel, runIDList, result1DManager);
	processCurves("1D Results/Power", runIDLabel, runIDList, result1DManager);
	processCurves("1D Results/Reference Impedance", runIDLabel, runIDList, result1DManager);
//	processSparameters("1D Results/S-Parameters", runIDLabel, runIDList,result1DManager);
...
void ParametricResult1DManager::processCurves(const std::string& category, const std::string &runIDLabel, std::list<int> &runIDList, Result1DManager& result1DManager)
{
	...
	for (auto runID : runIDList)
	{
...

		{
			...
			// Add the x-axis parameter
			// Determine axis type and value
