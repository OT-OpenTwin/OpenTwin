...
public:
	...
	OT_HANDLER(handleNewGraphicsItem, Application, OT_ACTION_CMD_UI_GRAPHICSEDITOR_AddItems, ot::SECURE_MESSAGE_TYPES);
	OT_HANDLER(handleNewGraphicsItemConnection, Application, OT_ACTION_CMD_UI_GRAPHICSEDITOR_AddConnections, ot::SECURE_MESSAGE_TYPES);
