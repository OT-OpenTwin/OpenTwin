// @otlicense
// File: TestTouchstoneOptionHandling.cpp
// 
// License:
...
//}
//
//TEST_F(FixtureTouchstoneHandler, V1_Example1Port_NumberOfDatapoints)
//{
//	setup1PortTest();
//	auto& quantityDescriptionData = getQuantityDescriptionData();
//	EXPECT_EQ(quantityDescriptionData.getNumberOfFirstValues(), 1);
//	EXPECT_EQ(quantityDescriptionData.getNumberOfSecondValues(), 1);
//}
//
//TEST_F(FixtureTouchstoneHandler, V1_Example1Port_NumberOfFrequencyPoints)
//{
//	setup1PortTest();
//	auto& frequencyMetadata= getFrequencyParameter();
//	EXPECT_EQ(frequencyMetadata.values.size(), 1);
//}
//
