...
extern "C"{
	...
	_declspec(dllexport) int init(const char * ownURL, const char * _unused1, const char * _unused2, const char * _unused3)
	{ return ot::foundation::init(ownURL, new Application(), false); };
}