// @otlicense
// File: VtkDriverUnstructuredVectorSurface.cpp
// 
// License:
...
std::string VtkDriverUnstructuredVectorSurface::buildSceneNode(DataSourceManagerItem *dataItem, std::string& colorRampData)
{
