// @otlicense
// File: VtkDriverUnstructuredVectorVolume.cpp
// 
// License:
...
std::string VtkDriverUnstructuredVectorVolume::buildSceneNode(DataSourceManagerItem *dataItem, std::string& colorRampData)
{
