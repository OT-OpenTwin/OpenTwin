...
vtkAlgorithmOutput * VtkDriverUnstructuredScalarSurface::ApplyCutplane(DataSourceResult3D *dataSource, osg::Node * parent)
{	
...
void VtkDriverUnstructuredScalarSurface::AssembleNode(vtkAlgorithmOutput * input, osg::Node *parent)
{
...
vtkAlgorithmOutput * VtkDriverUnstructuredScalarSurface::SetScalarValues(vtkAlgorithmOutput * input)
{
...
vtkAlgorithmOutput * VtkDriverUnstructuredScalarSurface::AddNodeVectors(vtkAlgorithmOutput * input)
{
