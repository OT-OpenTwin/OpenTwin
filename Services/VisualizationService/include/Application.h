...
private:
	...
	void sendNewVisualizationDataToModeler(EntityVis2D3D *visEntity, ot::UID binaryDataItemID, ot::UID binaryDataItemVersion, const std::string& colorRampData, const std::string& unit);
	std::pair<ot::UID, ot::UID> createDataItems(EntityVis2D3D *visEntity, std::string& colorRampData);
};
