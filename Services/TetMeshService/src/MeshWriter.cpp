...
void MeshWriter::convertFaces(void)
{
	...
	for (auto faceTag : faceTags)
	{
		...
		EntityMeshTetFace *meshFace = new EntityMeshTetFace(application->modelComponent()->createEntityUID(), nullptr, nullptr, nullptr, nullptr, application->serviceName());
...
{
	EntityMeshTetItem *meshItem = new EntityMeshTetItem(0, nullptr, nullptr, nullptr, nullptr, application->serviceName());
	...
	for (auto face : entityFaceTags)
	{
		...
		if (progressLogger->isInvalidSurface(faceTag))
		{
			...
			if (!faceIsValid)
			{
				...
				EntityAnnotation *annotation = new EntityAnnotation(application->modelComponent()->createEntityUID(), nullptr, nullptr, nullptr, nullptr, application->serviceName());
...
bool MeshWriter::storeMeshFile(void)
{
	...
	EntityBinaryData *fileData = new EntityBinaryData(application->modelComponent()->createEntityUID(), nullptr, nullptr, nullptr, nullptr, application->serviceName());
