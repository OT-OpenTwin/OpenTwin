...
ECHO ===============================================================
ECHO Clean Service: DebugService
ECHO ===============================================================
CALL "%OT_DEBUGSERVICE_ROOT%\Clean.bat"
...
ECHO ===============================================================
ECHO Clean Service: LT Spice Service
ECHO ===============================================================
CALL "%OT_LTSPICE_SERVICE_ROOT%\Clean.bat" 
...
ECHO ===============================================================
ECHO Clean Service: PyritService
ECHO ===============================================================
