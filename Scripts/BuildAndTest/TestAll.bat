...
ECHO ===============================================================
ECHO Test Library: BlockEditor
ECHO ===============================================================
CALL "%OT_BLOCKEDITOR_ROOT%%testBat%" %1 %2

ECHO ===============================================================
ECHO Test Library: BlockEditorAPI
ECHO ===============================================================
CALL "%OT_BLOCKEDITORAPI_ROOT%%testBat%" %1 %2
...
ECHO ===============================================================
ECHO Test Library: OTQtWrapper
ECHO ===============================================================
CALL "%OT_QTWRAPPER_ROOT%%testBat%" %1 %2
...
ECHO ===============================================================
ECHO Test Library: UIPluginAPI
ECHO ===============================================================
CALL "%OT_UIPLUGINAPI_ROOT%%testBat%" %1 %2
