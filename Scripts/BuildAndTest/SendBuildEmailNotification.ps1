...
$messageBody = "This is an automatically generated email from the nightly OpenTwin build.\nPlease take a look at the attachements for more detailed information"
