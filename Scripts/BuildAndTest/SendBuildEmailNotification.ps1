...
$messageBody = "This is an automatically generated email from the nightly OpenTwin build." + [Environment]::NewLine + [Environment]::NewLine +"Please take a look at the attachements for more detailed information"
