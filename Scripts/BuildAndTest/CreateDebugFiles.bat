...
COPY "%OT_MODELENTITIES_ROOT%\%OT_DLLR%\OTModelEntities.dll" "%OPENTWIN_DEBUG_FILES%"
COPY "%OT_CADMODELENTITIES_ROOT%\%OT_DLLR%\OTCADEntities.dll" "%OPENTWIN_DEBUG_FILES%"
COPY "%OT_VIEWER_ROOT%\%OT_DLLR%\OTViewer.dll" "%OPENTWIN_DEBUG_FILES%"
COPY "%OT_DATASTORAGE_ROOT%\%OT_DLLR%\OTDataStorage.dll" "%OPENTWIN_DEBUG_FILES%"
COPY "%OT_UICORE_ROOT%\%OT_DLLR%\uiCore.dll" "%OPENTWIN_DEBUG_FILES%"
COPY "%OT_RUBBERBANDAPI_ROOT%\%OT_DLLR%\OTRubberband.dll" "%OPENTWIN_DEBUG_FILES%"
COPY "%OT_RUBBERBAND_OSG_ROOT%\%OT_DLLR%\OTRubberbandOSG.dll" "%OPENTWIN_DEBUG_FILES%"
...
COPY "%OT_STUDIO_SUITE_CONNECTOR_ROOT%\%OT_DLLR%\OTStudioSuiteConnector.dll" "%OPENTWIN_DEBUG_FILES%"
COPY "%OT_LTSPICE_CONNECTOR_ROOT%\%OT_DLLR%\OTLTSpiceConnector.dll" "%OPENTWIN_DEBUG_FILES%"
