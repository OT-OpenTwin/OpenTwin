...
ECHO ======================================================================================== >> testlog_Debug.txt
PUSHD "%1"
ctest -C Debug --test-dir build/windows-debug/tests -V >> "%ORIGINAL_DIR%\testlog_Debug.txt"
POPD
...
ECHO ======================================================================================== >> testlog_Release.txt
PUSHD "%1"
ctest -C Release --test-dir build/windows-release/tests -V >> "%ORIGINAL_DIR%\testlog_Release.txt"
POPD
