...
COPY "%OT_LTSPICE_CONNECTOR_ROOT%\%OT_DLLR%\OTLTSpiceConnector.dll" "%OPENTWIN_FRONTEND_DEPLOYMENT%"
...
COPY "%OT_RUBBERBAND_OSG_ROOT%\%OT_DLLR%\OTRubberbandOSG.dll"    "%OPENTWIN_FRONTEND_DEPLOYMENT%"

REM FrontendConnectorAPI
COPY "%OT_FRONTEND_CONNECTOR_API_ROOT%\%OT_DLLR%\OTFrontendConnectorAPI.dll" "%OPENTWIN_FRONTEND_DEPLOYMENT%"
...
COPY "%OT_STUDIO_SUITE_CONNECTOR_ROOT%\%OT_DLLR%\OTStudioSuiteConnector.dll" "%OPENTWIN_FRONTEND_DEPLOYMENT%"
