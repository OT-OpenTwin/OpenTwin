...
COPY "%OT_CADMODELENTITIES_ROOT%\%OT_CDLLR%\CADModelEntities.dll" "%OPENTWIN_FRONTEND_DEPLOYMENT%"
...
COPY "%OT_RESULT_DATA_ACCESS_ROOT%\%OT_CDLLR%\ResultDataAccess.dll" "%OPENTWIN_FRONTEND_DEPLOYMENT%"
