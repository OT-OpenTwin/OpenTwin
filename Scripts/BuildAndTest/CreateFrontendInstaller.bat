...
COPY "%OSG_DLLR%\osgPlugins-3.6.3\osgdb_freetype.dll" "%OPENTWIN_FRONTEND_DEPLOYMENT%\osgPlugins-3.6.3"
COPY "%OSG_DLLR%\osgPlugins-3.6.3\osgdb_glsl.dll" "%OPENTWIN_FRONTEND_DEPLOYMENT%\osgPlugins-3.6.3"
