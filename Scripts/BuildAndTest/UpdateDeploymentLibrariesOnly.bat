...
DEL "%OPENTWIN_DEPLOYMENT_DIR%\PythonAPI.dll"
...
COPY "%OT_BLOCKEDITOR_ROOT%\%OT_DLLR%\BlockEditor.dll" "%OPENTWIN_DEPLOYMENT_DIR%"
COPY "%OT_BLOCKEDITORAPI_ROOT%\%OT_DLLR%\BlockEditorAPI.dll" "%OPENTWIN_DEPLOYMENT_DIR%"
...
COPY "%OT_PYTHONAPI_ROOT%\%OT_DLLR%\PythonAPI.dll" "%OPENTWIN_DEPLOYMENT_DIR%"
...
COPY "%OT_KRIGING_SERVICE_ROOT%\%OT_DLLR%\run.py" "%OPENTWIN_DEPLOYMENT_DIR%\Python"
