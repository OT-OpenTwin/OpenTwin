...
function(_ot_qt_module_include_subdir OUT_VAR MODULE_NAME)
    ...
    elseif(MODULE_NAME STREQUAL "Qml" )
        set(${OUT_VAR} "QtQml" PARENT_SCOPE)
    elseif(MODULE_NAME STREQUAL "WebSockets")
        set(${OUT_VAR} "QtWebSockets" PARENT_SCOPE)
    else()
        set(${OUT_VAR} "" PARENT_SCOPE)
    endif()
endfunction()
...
function(ot_define_qt6_targets COMPONENTS_LIST)
    ...
    foreach(c IN LISTS COMPONENTS_LIST)
        ...
        elseif(c STREQUAL "Qml")
            ot_import_qt6_module(Qml Qt6Qml)
            if(TARGET Qt6::Core)
                target_link_libraries(Qt6::Qml INTERFACE Qt6::Core)
            endif()

        elseif(c STREQUAL "WebSockets")
            ot_import_qt6_module(WebSockets Qt6WebSockets)
