...
SET OT_DEFAULT_SERVICE_INCD=%OT_CORE_ROOT%\%OT_INC%;%OT_SYSTEM_ROOT%\%OT_INC%;%OT_GUI_ROOT%\%OT_INC%;%OT_COMMUNICATION_ROOT%\%OT_INC%;%OT_FOUNDATION_ROOT%\%OT_INC%;%OT_MODELENTITIES_ROOT%\%OT_INC%;%OT_DATASTORAGE_ROOT%\%OT_INC%;%OT_UIPLUGINAPI_ROOT%\%OT_INC%;%R_JSON_INCD%;%CURL_INCD%;%MONGO_C_INCD%;%MONGO_CXX_INCD%;%MONGO_BOOST_INCD%
SET OT_DEFAULT_SERVICE_INCR=%OT_CORE_ROOT%\%OT_INC%;%OT_SYSTEM_ROOT%\%OT_INC%;%OT_GUI_ROOT%\%OT_INC%;%OT_COMMUNICATION_ROOT%\%OT_INC%;%OT_FOUNDATION_ROOT%\%OT_INC%;%OT_MODELENTITIES_ROOT%\%OT_INC%;%OT_DATASTORAGE_ROOT%\%OT_INC%;%OT_UIPLUGINAPI_ROOT%\%OT_INC%;%R_JSON_INCR%;%CURL_INCR%;%MONGO_C_INCR%;%MONGO_CXX_INCR%;%MONGO_BOOST_INCR%
...
SET OT_DEFAULT_SERVICE_LIBPATHD=%OT_CORE_ROOT%\%OT_LIBD%;%OT_SYSTEM_ROOT%\%OT_LIBD%;%OT_GUI_ROOT%\%OT_LIBD%;%OT_COMMUNICATION_ROOT%\%OT_LIBD%;%OT_FOUNDATION_ROOT%\%OT_LIBD%;%OT_MODELENTITIES_ROOT%\%OT_LIBD%;%OT_DATASTORAGE_ROOT%\%OT_LIBD%;%OT_UIPLUGINAPI_ROOT%\%OT_LIBD%;%CURL_LIBPATHD%;%MONGO_C_LIBPATHD%;%MONGO_CXX_LIBPATHD%
SET OT_DEFAULT_SERVICE_LIBPATHR=%OT_CORE_ROOT%\%OT_LIBR%;%OT_SYSTEM_ROOT%\%OT_LIBR%;%OT_GUI_ROOT%\%OT_LIBR%;%OT_COMMUNICATION_ROOT%\%OT_LIBR%;%OT_FOUNDATION_ROOT%\%OT_LIBR%;%OT_MODELENTITIES_ROOT%\%OT_LIBR%;%OT_DATASTORAGE_ROOT%\%OT_LIBR%;%OT_UIPLUGINAPI_ROOT%\%OT_LIBR%;%CURL_LIBPATHR%;%MONGO_C_LIBPATHR%;%MONGO_CXX_LIBPATHR%
...
SET OT_DEFAULT_SERVICE_LIBD=OTCore.lib;OTSystem.lib;OTGui.lib;OTCommunication.lib;OTServiceFoundation.lib;ModelEntities.lib;DataStorage.lib;UIPluginAPI.lib;%CURL_LIBD%;%MONGO_C_LIBD%;%MONGO_CXX_LIBD%
SET OT_DEFAULT_SERVICE_LIBR=OTCore.lib;OTSystem.lib;OTGui.lib;OTCommunication.lib;OTServiceFoundation.lib;ModelEntities.lib;DataStorage.lib;UIPluginAPI.lib;%CURL_LIBR%;%MONGO_C_LIBR%;%MONGO_CXX_LIBR%
