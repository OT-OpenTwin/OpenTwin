...
SET OT_DEFAULT_SERVICE_LIBPATHD=%OT_CORE_ROOT%\%OT_CLIBD%;%OT_SYSTEM_ROOT%\%OT_CLIBD%;%OT_GUI_ROOT%\%OT_LIBD%;%OT_COMMUNICATION_ROOT%\%OT_CLIBD%;%OT_GUIAPI_ROOT%\%OT_LIBD%;%OT_FOUNDATION_ROOT%\%OT_LIBD%;%OT_MODELENTITIES_ROOT%\%OT_LIBD%;%OT_DATASTORAGE_ROOT%\%OT_CLIBD%;%OT_MODELAPI_ROOT%\%OT_LIBD%;%CURL_LIBPATHD%;%MONGO_C_LIBPATHD%;%MONGO_CXX_LIBPATHD%
SET OT_DEFAULT_SERVICE_LIBPATHR=%OT_CORE_ROOT%\%OT_CLIBR%;%OT_SYSTEM_ROOT%\%OT_CLIBR%;%OT_GUI_ROOT%\%OT_LIBR%;%OT_COMMUNICATION_ROOT%\%OT_CLIBR%;%OT_GUIAPI_ROOT%\%OT_LIBR%;%OT_FOUNDATION_ROOT%\%OT_LIBR%;%OT_MODELENTITIES_ROOT%\%OT_LIBR%;%OT_DATASTORAGE_ROOT%\%OT_CLIBR%;%OT_MODELAPI_ROOT%\%OT_LIBR%;%CURL_LIBPATHR%;%MONGO_C_LIBPATHR%;%MONGO_CXX_LIBPATHR%
...
SET OT_DEFAULT_SERVICE_DLLD=%OT_CORE_ROOT%\%OT_CDLLD%;%OT_SYSTEM_ROOT%\%OT_CDLLD%;%OT_GUI_ROOT%\%OT_DLLD%;%OT_COMMUNICATION_ROOT%\%OT_CDLLD%;%OT_GUIAPI_ROOT%\%OT_DLLD%;%OT_FOUNDATION_ROOT%\%OT_DLLD%;%OT_MODELENTITIES_ROOT%\%OT_DLLD%;%OT_DATASTORAGE_ROOT%\%OT_CDLLD%;%OT_MODELAPI_ROOT%\%OT_DLLD%;%CURL_DLLD%;%MONGO_C_DLLD%;%MONGO_CXX_DLLD%;%CURL_DLLD%;%ZLIB_DLLPATHD%;%VTK_DLLD%;%OSG_DLLD%;%QT_DLLD%;%QWT_LIB_DLLD%;%QT_TT_DLLD%
SET OT_DEFAULT_SERVICE_DLLR=%OT_CORE_ROOT%\%OT_CDLLR%;%OT_SYSTEM_ROOT%\%OT_CDLLR%;%OT_GUI_ROOT%\%OT_DLLR%;%OT_COMMUNICATION_ROOT%\%OT_CDLLR%;%OT_GUIAPI_ROOT%\%OT_DLLR%;%OT_FOUNDATION_ROOT%\%OT_DLLR%;%OT_MODELENTITIES_ROOT%\%OT_DLLR%;%OT_DATASTORAGE_ROOT%\%OT_CDLLR%;%OT_MODELAPI_ROOT%\%OT_DLLR%;%CURL_DLLR%;%MONGO_C_DLLR%;%MONGO_CXX_DLLR%;%CURL_DLLR%;%ZLIB_DLLPATHR%;%VTK_DLLR%;%OSG_DLLR%;%QT_DLLR%;%QWT_LIB_DLLR%;%QT_TT_DLLR%

REM #########################################################################################################################################################################################################################################################################################################################################################################################
REM OpenTwin all services path

SET OT_ALL_DLLD=%OT_RESULT_DATA_ACCESS_ROOT%\%OT_DLLD%;%OT_CADMODELENTITIES_ROOT%\%OT_DLLD%;%OT_DATASTORAGE_ROOT%\%OT_CDLLD%;%OT_MODELAPI_ROOT%\%OT_DLLD%;%OT_MODELENTITIES_ROOT%\%OT_DLLD%;%OT_BLOCKENTITIES_ROOT%\%OT_DLLD%;%OT_COMMUNICATION_ROOT%\%OT_CDLLD%;%OT_CORE_ROOT%\%OT_CDLLD%;%OT_GUI_ROOT%\%OT_DLLD%;%OT_GUIAPI_ROOT%\%OT_DLLD%;%OT_FOUNDATION_ROOT%\%OT_DLLD%;%OT_SYSTEM_ROOT%\%OT_CDLLD%;%OT_GUI_ROOT%\%OT_DLLD%;%OT_WIDGETS_ROOT%\%OT_DLLD%;%OT_RUBBERBANDAPI_ROOT%\%OT_DLLD%;%OT_RUBBERBAND_ROOT%\%OT_DLLD%;%OT_UICORE_ROOT%\%OT_DLLD%;%OT_VIEWER_ROOT%\%OT_DLLD%;%MONGO_C_DLLD%;%MONGO_CXX_DLLD%;%CURL_DLLD%;%ZLIB_DLLPATHD%;%VTK_DLLD%;%OSG_DLLD%;%QT_DLLD%;%QWT_LIB_DLLD%;%QT_TT_DLLD%;%OT_STUDIO_SUITE_CONNECTOR_ROOT%\%OT_DLLD%;%OT_LTSPICE_CONNECTOR_ROOT%\%OT_DLLD%;%OT_FRONTEND_CONNECTOR_API_ROOT%\%OT_DLLD%;%OT_FILE_MANAGER_CONNECTOR_ROOT%\%OT_DLLD%
SET OT_ALL_DLLR=%OT_RESULT_DATA_ACCESS_ROOT%\%OT_DLLR%;%OT_CADMODELENTITIES_ROOT%\%OT_DLLR%;%OT_DATASTORAGE_ROOT%\%OT_CDLLR%;%OT_MODELAPI_ROOT%\%OT_DLLR%;%OT_MODELENTITIES_ROOT%\%OT_DLLR%;%OT_BLOCKENTITIES_ROOT%\%OT_DLLR%;%OT_COMMUNICATION_ROOT%\%OT_CDLLR%;%OT_CORE_ROOT%\%OT_CDLLR%;%OT_GUI_ROOT%\%OT_DLLR%;%OT_GUIAPI_ROOT%\%OT_DLLR%;%OT_FOUNDATION_ROOT%\%OT_DLLR%;%OT_SYSTEM_ROOT%\%OT_CDLLR%;%OT_GUI_ROOT%\%OT_DLLR%;%OT_WIDGETS_ROOT%\%OT_DLLR%;%OT_RUBBERBANDAPI_ROOT%\%OT_DLLR%;%OT_RUBBERBAND_ROOT%\%OT_DLLR%;%OT_UICORE_ROOT%\%OT_DLLR%;%OT_VIEWER_ROOT%\%OT_DLLR%;%MONGO_C_DLLR%;%MONGO_CXX_DLLR%;%CURL_DLLR%;%ZLIB_DLLPATHR%;%VTK_DLLR%;%OSG_DLLR%;%QT_DLLR%;%QWT_LIB_DLLR%;%QT_TT_DLLR%;%OT_STUDIO_SUITE_CONNECTOR_ROOT%\%OT_DLLR%;%OT_LTSPICE_CONNECTOR_ROOT%\%OT_DLLR%;%OT_FRONTEND_CONNECTOR_API_ROOT%\%OT_DLLR%;%OT_FILE_MANAGER_CONNECTOR_ROOT%\%OT_DLLR%
