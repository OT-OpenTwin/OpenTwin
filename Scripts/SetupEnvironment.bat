...
SET OT_OPENEMS_SERVICE_ROOT=%OPENTWIN_DEV_ROOT%\Services\OpenEMSService
...
SET OT_STUDIO_SUITE_CONNECTOR_ROOT=%OPENTWIN_DEV_ROOT%\Libraries\OTStudioSuiteConnector
SET OT_LTSPICE_CONNECTOR_ROOT=%OPENTWIN_DEV_ROOT%\Libraries\OTLTSpiceConnector

SET OT_RUBBERBANDAPI_ROOT=%OPENTWIN_DEV_ROOT%\Libraries\OTRubberband
SET OT_RUBBERBAND_OSG_ROOT=%OPENTWIN_DEV_ROOT%\Libraries\OTRubberbandOSG
SET OT_UICORE_ROOT=%OPENTWIN_DEV_ROOT%\Libraries\uiCore
SET OT_VIEWER_ROOT=%OPENTWIN_DEV_ROOT%\Libraries\OTViewer
...
SET OT_DEFAULT_SERVICE_LIBD=OTCore.lib;OTSystem.lib;OTGui.lib;OTCommunication.lib;OTGuiAPI.lib;OTServiceFoundation.lib;OTModelEntities.lib;OTDataStorage.lib;OTModelAPI.lib;%CURL_LIBD%;%MONGO_C_LIB%;%MONGO_CXX_LIB%;%MONGO_C_LIBD%
SET OT_DEFAULT_SERVICE_LIBR=OTCore.lib;OTSystem.lib;OTGui.lib;OTCommunication.lib;OTGuiAPI.lib;OTServiceFoundation.lib;OTModelEntities.lib;OTDataStorage.lib;OTModelAPI.lib;%CURL_LIBR%;%MONGO_C_LIB%;%MONGO_CXX_LIB%;%MONGO_C_LIBR%
