...
REM SET OT_DEFAULT_SERVICE_INCD=%OT_CORE_ROOT%\%OT_INC%;%OT_SYSTEM_ROOT%\%OT_INC%;%OT_COMMUNICATION_ROOT%\%OT_INC%;%OT_FOUNDATION_ROOT%\%OT_INC%;%OT_MODELENTITIES_ROOT%\%OT_INC%;%OT_DATASTORAGE_ROOT%\%OT_INC%;%R_JSON_INCD%;%CURL_INCD%;%MONGO_C_ROOT%\Debug\include;%MONGO_CXX_ROOT%\Debug\include;%MONGO_BOOST_ROOT%
REM SET OT_DEFAULT_SERVICE_INCR=%OT_CORE_ROOT%\%OT_INC%;%OT_SYSTEM_ROOT%\%OT_INC%;%OT_COMMUNICATION_ROOT%\%OT_INC%;%OT_FOUNDATION_ROOT%\%OT_INC%;%OT_MODELENTITIES_ROOT%\%OT_INC%;%OT_DATASTORAGE_ROOT%\%OT_INC%;%R_JSON_INCR%;%CURL_INCD%;%MONGO_C_ROOT%\Release\include;%MONGO_CXX_ROOT%\Release\include;%MONGO_BOOST_ROOT%
SET OT_DEFAULT_SERVICE_INCD=%OT_CORE_ROOT%\%OT_INC%;%OT_SYSTEM_ROOT%\%OT_INC%;%OT_GUI_ROOT%\%OT_INC%;%OT_COMMUNICATION_ROOT%\%OT_INC%;%OT_GUIAPI_ROOT%\%OT_INC%;%OT_FOUNDATION_ROOT%\%OT_INC%;%OT_MODELENTITIES_ROOT%\%OT_INC%;%OT_DATASTORAGE_ROOT%\%OT_INC%;%R_JSON_INCD%;%CURL_INCD%;%MONGO_C_INC%;%MONGO_CXX_INC%;%MONGO_BOOST_INCD%
SET OT_DEFAULT_SERVICE_INCR=%OT_CORE_ROOT%\%OT_INC%;%OT_SYSTEM_ROOT%\%OT_INC%;%OT_GUI_ROOT%\%OT_INC%;%OT_COMMUNICATION_ROOT%\%OT_INC%;%OT_GUIAPI_ROOT%\%OT_INC%;%OT_FOUNDATION_ROOT%\%OT_INC%;%OT_MODELENTITIES_ROOT%\%OT_INC%;%OT_DATASTORAGE_ROOT%\%OT_INC%;%R_JSON_INCR%;%CURL_INCR%;%MONGO_C_INC%;%MONGO_CXX_INC%;%MONGO_BOOST_INCR%

REM SET OT_DEFAULT_SERVICE_LIBPATHD=%OT_CORE_ROOT%\x64\Debug;%OT_SYSTEM_ROOT%\x64\Debug;%OT_COMMUNICATION_ROOT%\x64\Debug;%OT_FOUNDATION_ROOT%\x64\Debug;%OT_MODELENTITIES_ROOT%\x64\Debug;%OT_DATASTORAGE_ROOT%\x64\Debug;%CURL_LIB%;%MONGO_C_ROOT%\Debug\lib;%MONGO_CXX_ROOT%\Debug\lib;%ZLIB_LIB%\Debug\lib
REM SET OT_DEFAULT_SERVICE_LIBPATHR=%OT_CORE_ROOT%\x64\Release;%OT_SYSTEM_ROOT%\x64\Release;%OT_COMMUNICATION_ROOT%\x64\Release;%OT_FOUNDATION_ROOT%\x64\Release;%OT_MODELENTITIES_ROOT%\x64\Release;%OT_DATASTORAGE_ROOT%\x64\Release;%CURL_LIB%;%MONGO_C_ROOT%\Release\lib;%MONGO_CXX_ROOT%\Release\lib;%ZLIB_LIB%\Release\lib
SET OT_DEFAULT_SERVICE_LIBPATHD=%OT_CORE_ROOT%\%OT_LIBD%;%OT_SYSTEM_ROOT%\%OT_LIBD%;%OT_GUI_ROOT%\%OT_LIBD%;%OT_COMMUNICATION_ROOT%\%OT_LIBD%;%OT_GUIAPI_ROOT%\%OT_LIBD%;%OT_FOUNDATION_ROOT%\%OT_LIBD%;%OT_MODELENTITIES_ROOT%\%OT_LIBD%;%OT_DATASTORAGE_ROOT%\%OT_LIBD%;%CURL_LIBPATHD%;%MONGO_C_LIBPATHD%;%MONGO_CXX_LIBPATHD%
SET OT_DEFAULT_SERVICE_LIBPATHR=%OT_CORE_ROOT%\%OT_LIBR%;%OT_SYSTEM_ROOT%\%OT_LIBR%;%OT_GUI_ROOT%\%OT_LIBR%;%OT_COMMUNICATION_ROOT%\%OT_LIBR%;%OT_GUIAPI_ROOT%\%OT_LIBR%;%OT_FOUNDATION_ROOT%\%OT_LIBR%;%OT_MODELENTITIES_ROOT%\%OT_LIBR%;%OT_DATASTORAGE_ROOT%\%OT_LIBR%;%CURL_LIBPATHR%;%MONGO_C_LIBPATHR%;%MONGO_CXX_LIBPATHR%
...
SET OT_DEFAULT_SERVICE_LIBD=OTCore.lib;OTSystem.lib;OTGui.lib;OTCommunication.lib;OTGuiAPI.lib;OTServiceFoundation.lib;ModelEntities.lib;DataStorage.lib;%CURL_LIBD%;%MONGO_C_LIB%;%MONGO_CXX_LIB%;%MONGO_C_LIBD%
SET OT_DEFAULT_SERVICE_LIBR=OTCore.lib;OTSystem.lib;OTGui.lib;OTCommunication.lib;OTGuiAPI.lib;OTServiceFoundation.lib;ModelEntities.lib;DataStorage.lib;%CURL_LIBR%;%MONGO_C_LIB%;%MONGO_CXX_LIB%;%MONGO_C_LIBR%

REM SET OT_DEFAULT_SERVICE_DLLD=%OT_CORE_ROOT%\x64\Debug;%OT_SYSTEM_ROOT%\x64\Debug;%OT_COMMUNICATION_ROOT%\x64\Debug;%OT_FOUNDATION_ROOT%\x64\Debug;%OT_MODELENTITIES_ROOT%\x64\Debug;%OT_DATASTORAGE_ROOT%\x64\Debug;%CURL_DLLD%;%MONGO_C_ROOT%\Debug\bin;%MONGO_CXX_ROOT%\Debug\bin
REM SET OT_DEFAULT_SERVICE_DLLR=%OT_CORE_ROOT%\x64\Release;%OT_SYSTEM_ROOT%\x64\Release;%OT_COMMUNICATION_ROOT%\x64\Release;%OT_FOUNDATION_ROOT%\x64\Release;%OT_MODELENTITIES_ROOT%\x64\Release;%OT_DATASTORAGE_ROOT%\x64\Release;%CURL_DLL%;%MONGO_C_ROOT%\Release\bin;%MONGO_CXX_ROOT%\Release\bin
SET OT_DEFAULT_SERVICE_DLLD=%OT_CORE_ROOT%\%OT_DLLD%;%OT_SYSTEM_ROOT%\%OT_DLLD%;%OT_GUI_ROOT%\%OT_DLLD%;%OT_COMMUNICATION_ROOT%\%OT_DLLD%;%OT_GUIAPI_ROOT%\%OT_DLLD%;%OT_FOUNDATION_ROOT%\%OT_DLLD%;%OT_MODELENTITIES_ROOT%\%OT_DLLD%;%OT_DATASTORAGE_ROOT%\%OT_DLLD%;%CURL_DLLD%;%MONGO_C_DLLD%;%MONGO_CXX_DLLD%;%CURL_DLLD%;%ZLIB_DLLPATHD%;%VTK_DLLD%;%OSG_DLLD%;%QT_DLLD%;%QWT_LIB_DLLD%;%QT_TT_DLLD%
SET OT_DEFAULT_SERVICE_DLLR=%OT_CORE_ROOT%\%OT_DLLR%;%OT_SYSTEM_ROOT%\%OT_DLLR%;%OT_GUI_ROOT%\%OT_DLLR%;%OT_COMMUNICATION_ROOT%\%OT_DLLR%;%OT_GUIAPI_ROOT%\%OT_DLLR%;%OT_FOUNDATION_ROOT%\%OT_DLLR%;%OT_MODELENTITIES_ROOT%\%OT_DLLR%;%OT_DATASTORAGE_ROOT%\%OT_DLLR%;%CURL_DLLR%;%MONGO_C_DLLR%;%MONGO_CXX_DLLR%;%CURL_DLLR%;%ZLIB_DLLPATHR%;%VTK_DLLR%;%OSG_DLLR%;%QT_DLLR%;%QWT_LIB_DLLR%;%QT_TT_DLLR%

REM #########################################################################################################################################################################################################################################################################################################################################################################################
REM OpenTwin all services path

SET OT_ALL_DLLD=%OT_RESULT_DATA_ACCESS_ROOT%\%OT_DLLD%;%OT_BLOCKEDITORAPI_ROOT%\%OT_DLLD%;%OT_CADMODELENTITIES_ROOT%\%OT_DLLD%;%OT_DATASTORAGE_ROOT%\%OT_DLLD%;%OT_MODELENTITIES_ROOT%\%OT_DLLD%;%OT_BLOCKENTITIES_ROOT%\%OT_DLLD%;%OT_COMMUNICATION_ROOT%\%OT_DLLD%;%OT_CORE_ROOT%\%OT_DLLD%;%OT_GUI_ROOT%\%OT_DLLD%;%OT_GUIAPI_ROOT%\%OT_DLLD%;%OT_FOUNDATION_ROOT%\%OT_DLLD%;%OT_SYSTEM_ROOT%\%OT_DLLD%;%OT_GUI_ROOT%\%OT_DLLD%;%OT_WIDGETS_ROOT%\%OT_DLLD%;%OT_QWTWRAPPER_ROOT%\%OT_DLLD%;%OT_RUBBERBANDAPI_ROOT%\%OT_DLLD%;%OT_RUBBERBAND_ROOT%\%OT_DLLD%;%OT_UICORE_ROOT%\%OT_DLLD%;%OT_VIEWER_ROOT%\%OT_DLLD%;%MONGO_C_DLLD%;%MONGO_CXX_DLLD%;%CURL_DLLD%;%ZLIB_DLLPATHD%;%VTK_DLLD%;%OSG_DLLD%;%QT_DLLD%;%QWT_LIB_DLLD%;%QT_TT_DLLD%;%OT_STUDIO_SUITE_CONNECTOR_ROOT%\%OT_DLLD%;%OT_LTSPICE_CONNECTOR_ROOT%\%OT_DLLD%
SET OT_ALL_DLLR=%OT_RESULT_DATA_ACCESS_ROOT%\%OT_DLLR%;%OT_BLOCKEDITORAPI_ROOT%\%OT_DLLR%;%OT_CADMODELENTITIES_ROOT%\%OT_DLLR%;%OT_DATASTORAGE_ROOT%\%OT_DLLR%;%OT_MODELENTITIES_ROOT%\%OT_DLLR%;%OT_BLOCKENTITIES_ROOT%\%OT_DLLR%;%OT_COMMUNICATION_ROOT%\%OT_DLLR%;%OT_CORE_ROOT%\%OT_DLLR%;%OT_GUI_ROOT%\%OT_DLLR%;%OT_GUIAPI_ROOT%\%OT_DLLR%;%OT_FOUNDATION_ROOT%\%OT_DLLR%;%OT_SYSTEM_ROOT%\%OT_DLLR%;%OT_GUI_ROOT%\%OT_DLLR%;%OT_WIDGETS_ROOT%\%OT_DLLR%;%OT_QWTWRAPPER_ROOT%\%OT_DLLR%;%OT_RUBBERBANDAPI_ROOT%\%OT_DLLR%;%OT_RUBBERBAND_ROOT%\%OT_DLLR%;%OT_UICORE_ROOT%\%OT_DLLR%;%OT_VIEWER_ROOT%\%OT_DLLR%;%MONGO_C_DLLR%;%MONGO_CXX_DLLR%;%CURL_DLLR%;%ZLIB_DLLPATHR%;%VTK_DLLR%;%OSG_DLLR%;%QT_DLLR%;%QWT_LIB_DLLR%;%QT_TT_DLLR%;%OT_STUDIO_SUITE_CONNECTOR_ROOT%\%OT_DLLR%;%OT_LTSPICE_CONNECTOR_ROOT%\%OT_DLLR% 
