...
SET OT_DEFAULT_SERVICE_LIBD=OTCore.lib;OTSystem.lib;OTGui.lib;OTCommunication.lib;OTGuiAPI.lib;OTServiceFoundation.lib;ModelEntities.lib;DataStorage.lib;UIPluginAPI.lib;%CURL_LIBD%;%MONGO_C_LIBD%;%MONGO_CXX_LIBD%
SET OT_DEFAULT_SERVICE_LIBR=OTCore.lib;OTSystem.lib;OTGui.lib;OTCommunication.lib;OTGuiAPI.lib;OTServiceFoundation.lib;ModelEntities.lib;DataStorage.lib;UIPluginAPI.lib;%CURL_LIBR%;%MONGO_C_LIBR%;%MONGO_CXX_LIBR%
