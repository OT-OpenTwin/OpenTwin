...
SET OT_DEFAULT_SERVICE_LIBPATHD=%OT_CORE_ROOT%\%OT_LIBD%;%OT_SYSTEM_ROOT%\%OT_LIBD%;%OT_GUI_ROOT%\%OT_LIBD%;%OT_COMMUNICATION_ROOT%\%OT_LIBD%;%OT_GUIAPI_ROOT%\%OT_LIBD%;%OT_FOUNDATION_ROOT%\%OT_LIBD%;%OT_MODELENTITIES_ROOT%\%OT_LIBD%;%OT_DATASTORAGE_ROOT%\%OT_LIBD%;%OT_MODELAPI_ROOT%\%OT_LIBD%;%CURL_LIBPATHD%;%MONGO_C_LIBPATHD%;%MONGO_CXX_LIBPATHD%
SET OT_DEFAULT_SERVICE_LIBPATHR=%OT_CORE_ROOT%\%OT_LIBR%;%OT_SYSTEM_ROOT%\%OT_LIBR%;%OT_GUI_ROOT%\%OT_LIBR%;%OT_COMMUNICATION_ROOT%\%OT_LIBR%;%OT_GUIAPI_ROOT%\%OT_LIBR%;%OT_FOUNDATION_ROOT%\%OT_LIBR%;%OT_MODELENTITIES_ROOT%\%OT_LIBR%;%OT_DATASTORAGE_ROOT%\%OT_LIBR%;%OT_MODELAPI_ROOT%\%OT_LIBR%;%CURL_LIBPATHR%;%MONGO_C_LIBPATHR%;%MONGO_CXX_LIBPATHR%
