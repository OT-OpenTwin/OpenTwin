...
SET OT_DEFAULT_SERVICE_DLLD=%OT_CORE_ROOT%\%OT_CDLLD%;%OT_SYSTEM_ROOT%\%OT_CDLLD%;%OT_GUI_ROOT%\%OT_CDLLD%;%OT_COMMUNICATION_ROOT%\%OT_CDLLD%;%OT_GUIAPI_ROOT%\%OT_CDLLD%;%OT_FOUNDATION_ROOT%\%OT_CDLLD%;%OT_MODELENTITIES_ROOT%\%OT_CDLLD%;%OT_DATASTORAGE_ROOT%\%OT_CDLLD%;%OT_MODELAPI_ROOT%\%OT_DLLD%;%CURL_DLLD%;%MONGO_C_DLLD%;%MONGO_CXX_DLLD%;%CURL_DLLD%;%ZLIB_DLLPATHD%;%VTK_DLLD%;%OSG_DLLD%;%QT_DLLD%;%QWT_LIB_DLLD%;%QT_TT_DLLD%
