...
#include "Tools/GraphicsItemDesigner/GraphicsItemDesignerImageExportConfig.h"
...
public:
	...
	virtual QString getToolName(void) const override { return QString("Graphics Item Designer"); };
